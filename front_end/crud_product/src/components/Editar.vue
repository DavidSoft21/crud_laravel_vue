            ...
            <div class="card-body">
                <form v-on:submit.prevent="editarRegistro()">
                    <div class="mb-3">
                        ...
                        <input disabled name="id" v-model="producto.id" type="text" placeholder="id" class="form-control" id="id"
                            aria-describedby="id" />
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" v-model="producto.price" class="form-control" id="price" name="price" aria-describedby="precio"
                            placeholder="price" />
                    </div>
...
export default {
    ...
    methods: {
        async showProducto() {
            ...
            const registro =  await fetch("http://127.0.0.1:8000/api/product/" + this.$route.params.id)
        ...
        editarRegistro() {
            ...
            fetch("http://localhost:8000/api/product_update/"+this.producto.id, optionsRequest)
